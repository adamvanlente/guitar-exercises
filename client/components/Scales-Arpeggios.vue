<template>
  <div class="scale-wrapper" v-if="currentExercise">

    <div class="scale-heading">
      <div class="scale-key-label">key of</div>
      <div class="scale-key-name">{{ currentExercise.key }}
        <label class="arpeggio-label">{{ currentExercise.name }}</label>
      </div>
    </div>
    ...
    <div class="scale-labels">
      <label class="standard-style">{{ currentExercise.type }}</label>
